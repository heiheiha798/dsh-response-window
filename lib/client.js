  ...
  factory: (require) => {
    ...
    function injectStyles() {
      ...
      el.textContent = [
        ...
        '.drw-think-body { margin: 0; padding: 2px 10px 8px 30px; color: var(--dsw-alias-label-primary, #eee); font: var(--dsw-font-markdown-code-block-small, 12px/1.5 ui-monospace, monospace); white-space: pre-wrap; word-break: break-word; max-height: 240px; overflow-y: auto; }',
